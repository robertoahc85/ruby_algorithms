...
#  For example "ac" can be replaced with "b" but "aa" cannot be replaced with anything. This method is done repeatedly until the string cannot be further reduced, and the length of the resulting string is to be outputted.
...
def StringReduction(str)
 ...
 return str.chars.count
  ...
  puts  StringReduction("cab")
 puts  StringReduction("abcabc")
 puts  StringReduction("cccc")